...
try {
  ...
  run("focused-tests", process.execPath, ["--test", "--test-concurrency=1", "--test-timeout=45000",
    "examples/drop-in-react/test/ChatLabDatabase.test.mjs", "examples/drop-in-react/test/ChatLabDatabasePostgres.test.mjs"]);
