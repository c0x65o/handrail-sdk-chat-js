...
const output = await mkdtemp(resolve(root, "build/react-named-threads-"));
function run(args) {
...
try {
  ...
  for (const [file, pattern] of [
    ["chat-workspace-default", "inline Reply routing|Reply starts|default public actions|reply style settings|host settings content|named thread"],
